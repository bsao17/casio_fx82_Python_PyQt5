...
if __name__ == '__main__':
    ...
    keyboard.on_press_key(".", lambda _: casio.displayDot())
    keyboard.on_press_key("+", lambda _: casio.bmore())
    keyboard.on_press_key("-", lambda _: casio.bless())
    keyboard.on_press_key("*", lambda _: casio.bnoun())
    keyboard.on_press_key("/", lambda _: casio.bdivide())
    keyboard.on_press_key("enter", lambda _: casio.pressEqual())
    keyboard.on_press_key("a", lambda _: casio.eraseScreen())
    keyboard.on_press_key("c", lambda _: casio.eraseMemory())
